      ...
      <div class="row">
        <div class="col-md-4">
          <div class="project-wrap hotel">
            <a href="#" class="img" style={{ backgroundImage: `url(${require("../images/hotel-resto-1.jpg")})` }}>
        ...
        <div class="col-md-4">
          <div class="project-wrap hotel">
            <a href="#" class="img" style={{ backgroundImage: `url(${require("../images/hotel-resto-2.jpg")})` }}>
              <span class="price">$200/person</span>
            </a>
            <div class="text p-4">
              <p class="star mb-2">
        ...
        <div class="col-md-4">
          <div class="project-wrap hotel">
            <a href="#" class="img" style={{ backgroundImage: `url(${require("../images/hotel-resto-3.jpg")})` }}>
                              <span class="price">$200/person</span>
            </a>
            <div class="text p-4">
              <p class="star mb-2">
        ...
        <div class="col-md-4">
          <div class="project-wrap hotel">
            <a href="#" class="img" style={{ backgroundImage: `url(${require("../images/hotel-resto-4.jpg")})` }}>
              <span class="price">$200/person</span>
            </a>
            <div class="text p-4">
              <p class="star mb-2">
        ...
        <div class="col-md-4">
          <div class="project-wrap hotel">
            <a href="#" class="img" style={{ backgroundImage: `url(${require("../images/hotel-resto-5.jpg")})` }}>
              <span class="price">$200/person</span>
            </a>
            <div class="text p-4">
              <p class="star mb-2">
        ...
        <div class="col-md-4">
          <div class="project-wrap hotel">
            <a href="#" class="img" style={{ backgroundImage: `url(${require("../images/hotel-resto-6.jpg")})` }}>
              <span class="price">$200/person</span>
            </a>
            <div class="text p-4">
              <p class="star mb-2">
        ...
        <div class="col-md-4">
          <div class="project-wrap hotel">
            <a href="#" class="img" style={{ backgroundImage: `url(${require("../images/hotel-resto-7.jpg")})` }}>
              <span class="price">$200/person</span>
            </a>
            <div class="text p-4">
              <p class="star mb-2">
        ...
        <div class="col-md-4">
          <div class="project-wrap hotel">
            <a href="#" class="img" style={{ backgroundImage: `url(${require("../images/hotel-resto-8.jpg")})` }}>
              <span class="price">$200/person</span>
            </a>
            <div class="text p-4">
              <p class="star mb-2">
        ...
        <div class="col-md-4">
          <div class="project-wrap hotel">
            <a href="#" class="img" style={{ backgroundImage: `url(${require("../images/hotel-resto-9.jpg")})` }}>
